...
import { Mail, Lock, Stethoscope, Eye, EyeOff, ArrowRight } from "lucide-react";
        ...
        <div className="glass-card rounded-3xl p-8 shadow-2xl shadow-blue-500/10 dark:shadow-none backdrop-blur-3xl bg-white/80 dark:bg-slate-900/60 border border-white/30 dark:border-slate-700/50">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400">
              SmileCraft CMS - نظام إدارة العيادة
            </p>
          </div>

          {/* Demo Credentials Badge */}
          <div className="mb-6 flex justify-center">
            <Badge variant="outline" className="text-xs bg-amber-50 dark:bg-amber-900/20 border-amber-200 dark:border-amber-800 text-amber-700 dark:text-amber-400">
