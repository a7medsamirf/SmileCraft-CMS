...
type SettingsTab = "services" | "permissions" | "schedule" | "backup";
  ...
  return (
    <div className="w-full mx-auto animate-in fade-in duration-500 pb-20">
      ...
      <div className="flex flex-col lg:flex-row gap-8 items-start">
        {/* Sidebar Tabs */}
        <aside className="w-full lg:w-64 shrink-0 space-y-2 glass-card p-2 shadow-sm transition-all duration-300">
          {tabs.map((tab) => {
            const Icon = tab.icon;
